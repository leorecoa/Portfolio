      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <SectionTitle 
            ...
            title={<>Code <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/40 to-white/10 italic">Portfolio</span></>} 
          />
            ...
            {loading ? (
              ...
              repos.map((project, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <GlassCard className="aspect-[4/5] p-10 flex flex-col justify-end">
