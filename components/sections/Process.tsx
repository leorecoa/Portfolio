...
import { Code2, ListChecks, Network, ShieldCheck, Zap, type LucideIcon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-8">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-bold font-space leading-[0.9] tracking-tighter">
              Como Eu <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">Construo</span>
            </h2>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {PROCESS_STEPS.map((step, index) => {
            const IconComponent = ICONS[step.icon] || Zap;
            return (
              <motion.div
                key={index}
